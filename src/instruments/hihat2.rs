...
impl HiHat2Config {
    ...
    pub fn short() -> Self {
        Self::new(0.76, 0.05, 0.0, NoiseColor::White, FilterSlope::Db24, 1.0)
    }

    pub fn loose() -> Self {
        Self::new(0.76, 0.30, 0.0, NoiseColor::White, FilterSlope::Db24, 1.0)
    }

    pub fn dark() -> Self {
        Self::new(0.41, 0.05, 0.0, NoiseColor::White, FilterSlope::Db24, 0.15)
    }
...
impl HiHat2 {
    ...
    pub fn tick(&mut self, current_time: f32) -> f32 {
        ...
        let output = filtered * env * OUTPUT_GAIN * self.current_velocity * 0.5;
