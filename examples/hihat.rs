/* CLI example for hi-hat testing with waveform visualization.
Minimal code to start the audio engine and trigger hi-hat hits, with real-time waveform display.
*/
